 ...
 * @return none.
 */
void nds_abs_f32(float32_t *src, float32_t *dst, uint32_t size);
 ...
 */
void nds_abs_q31(q31_t *src, q31_t *dst, uint32_t size);
 ...
 */
void nds_abs_q15(q15_t *src, q15_t *dst, uint32_t size);
 ...
 */
void nds_abs_q7(q7_t *src, q7_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_add_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);
 ...
 */
void nds_add_q31(q31_t *src1, q31_t *src2, q31_t *dst, uint32_t size);
 ...
 */
void nds_add_q15(q15_t *src1, q15_t *src2, q15_t *dst, uint32_t size);
 ...
 */
void nds_add_q7(q7_t *src1, q7_t *src2, q7_t *dst, uint32_t size);
 ...
 */
void nds_add_u8_u16(uint8_t *src1, uint8_t *src2, uint16_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_sub_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
void nds_sub_q31(q31_t *src1, q31_t *src2, q31_t *dst, uint32_t size);
 ...
 * The output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
void nds_sub_q15(q15_t *src1, q15_t *src2, q15_t *dst, uint32_t size);
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
void nds_sub_q7(q7_t *src1, q7_t *src2, q7_t *dst, uint32_t size);
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
void nds_sub_u8_q7(uint8_t *src1, uint8_t *src2, q7_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_mul_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
void nds_mul_q31(q31_t *src1, q31_t *src2, q31_t *dst, uint32_t size);
 ...
 */
void nds_mul_q15(q15_t *src1, q15_t *src2, q15_t *dst, uint32_t size);
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
void nds_mul_q7(q7_t *src1, q7_t *src2, q7_t *dst, uint32_t size);
 ...
 */
void nds_mul_u8_u16(uint8_t *src1, uint8_t *src2, uint16_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_div_f32(float32_t *src1, float32_t *src2, float32_t *dst, uint32_t size);
 ...
 */
q31_t nds_div_q31(q31_t src1, q31_t src2);
 ...
 * @return division of two inputs.
 */
q31_t nds_div_s64_u32(q63_t src1, uint32_t src2);
 ...
 * @return division of two inputs.
 */
q31_t nds_div_u64_u32(uint64_t src1, uint32_t src2);
 ...
 * @return none.
 */
void nds_neg_f32(float32_t *src, float32_t *dst, uint32_t size);
 ...
 * allowable positive value INT32_MAX.
 */
void nds_neg_q31(q31_t *src, q31_t *dst, uint32_t size);
 ...
 * allowable positive value INT16_MAX.
 */
void nds_neg_q15(q15_t *src, q15_t *dst, uint32_t size);
 ...
 */
void nds_neg_q7(q7_t *src, q7_t *dst, uint32_t size);
 ...
 */
float32_t nds_dprod_f32(float32_t *src1, float32_t *src2,
                             uint32_t size);
 ...
 * no risk to overflow.
 */
q63_t nds_dprod_q31(q31_t *src1, q31_t *src2, uint32_t size);
 ...
 */
q63_t nds_dprod_q15(q15_t *src1, q15_t *src2, uint32_t size);
...
q31_t nds_dprod_u8xq15(uint8_t *src1, q15_t *src2, uint32_t size);
 ...
 */
q31_t nds_dprod_q7(q7_t *src1, q7_t *src2, uint32_t size);
 ...
 */
uint32_t nds_dprod_u8(uint8_t *src1, uint8_t *src2, uint32_t size);
 ...
 * @return none.
 */
void nds_offset_f32(float32_t *src, float32_t offset, float32_t *dst,
                      uint32_t size);
 ...
 */
void nds_offset_q31(q31_t *src, q31_t offset, q31_t *dst, uint32_t size);
 ...
 */
void nds_offset_q15(q15_t *src, q15_t offset, q15_t *dst, uint32_t size);
 ...
 */
void nds_offset_u8(uint8_t *src, q7_t offset, uint8_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_scale_f32(float32_t *src, float32_t scale, float32_t *dst,
                     uint32_t size);
 ...
 */
void nds_scale_q31(q31_t *src, q31_t scalefract, int8_t shift,
 ...
 */
void nds_scale_q15(q15_t *src, q15_t scalefract, int8_t shift,
 ...
 */
void nds_scale_q7(q7_t *src, q7_t scalefract, int8_t shift,
 ...
 */
void nds_scale_u8(uint8_t *src, q7_t scalefract, int8_t shift, uint8_t *dst, uint32_t size);
 ...
 */
void nds_shift_q15(q15_t *src, int8_t shift, q15_t *dst, uint32_t size);
 ...
 */
void nds_shift_q31(q31_t *src, int8_t shift, q31_t *dst, uint32_t size);
 ...
 */
void nds_shift_q7(q7_t *src, int8_t shift, q7_t *dst, uint32_t size);
 ...
 */
void nds_shift_u8(uint8_t *src, int8_t shift, uint8_t *dst, uint32_t size);
