 ...
 * @return none.
 */
static inline void nds_clarke_f32(float32_t a, float32_t b, float32_t *alpha,
                      float32_t *beta)
{
...
#else
    nds_empty_func4(a, b, alpha, beta);
#endif
}
/**
 ...
 */
static inline void nds_clarke_q31(q31_t a, q31_t b, q31_t *alpha, q31_t *beta)
{
#ifndef ENA_EMPTY_FUNC
 ...
 * @return none.
 */
static inline void nds_inv_clarke_f32(float32_t alpha, float32_t beta, float32_t *a,
                                        float32_t *b)
{
#ifndef ENA_EMPTY_FUNC
    *a = alpha;
...
#else
    nds_empty_func4(alpha, beta, a, b);
#endif
}
/**
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void nds_inv_clarke_q31(q31_t alpha, q31_t beta, q31_t *a, q31_t *b)
{
#ifndef ENA_EMPTY_FUNC
 ...
 * @return none.
 */
static inline void nds_park_f32(float32_t alpha, float32_t beta, float32_t *a,
...
#else
    nds_empty_func6(alpha, beta, a, b, sin, cos);
#endif
}
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void nds_park_q31(q31_t alpha, q31_t beta, q31_t *a, q31_t *b,
                                  q31_t sin, q31_t cos)
{
#ifndef ENA_EMPTY_FUNC
 ...
 * @return none.
 */
static inline void nds_inv_park_f32(float32_t a, float32_t b, float32_t *alpha,
                                      float32_t *beta, float32_t sin, float32_t cos)
{
    ...
    *beta = a * sin + b * cos;
#else
    nds_empty_func6(a, b, alpha, beta, sin, cos);
#endif
}
/**
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void nds_inv_park_q31(q31_t a, q31_t b, q31_t *alpha, q31_t *beta,
                                      q31_t sin, q31_t cos)
{
#ifndef ENA_EMPTY_FUNC
    q31_t tmp1, tmp2, tmp3, tmp4;
 ...
 */
static inline
float32_t nds_pid_f32(nds_pid_f32_t *instance, float32_t src)
{
#ifndef ENA_EMPTY_FUNC
    float32_t dst;
    ...
    return dst;
#else
    nds_empty_ret_func2(instance, src);
#endif
}
/**
 ...
 */
void nds_init_pid_f32(nds_pid_f32_t *instance, int32_t set);
 ...
 * @return output data.
 */
static inline q31_t nds_pid_q31(nds_pid_q31_t *instance, q31_t src)
{
#ifndef ENA_EMPTY_FUNC
    q63_t tmp;
    q31_t dst;
 ...
 * state variable will set to all zeros.
 */
void nds_init_pid_q31(nds_pid_q31_t *instance, int32_t set);
...
static inline q15_t nds_pid_q15(nds_pid_q15_t *instance, q15_t src)
{
#ifndef ENA_EMPTY_FUNC
    q31_t ret;
 ...
 * state variable will set to all zeros.
 */
void nds_init_pid_q15(nds_pid_q15_t *instance, int32_t set);
