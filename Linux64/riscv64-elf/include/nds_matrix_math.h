 ...
 * @return none.
 */
void nds_mat_add_f32(const float32_t *src1, const float32_t *src2,
 ...
 */
void nds_mat_add_q15(const q15_t *src1, const q15_t *src2,
 ...
 */
void nds_mat_add_q31(const q31_t *src1, const q31_t *src2,
 ...
 */
int32_t nds_mat_inv_f32(float32_t *src, float32_t *dst, uint32_t size);
int32_t nds_mat_inv_f64(float64_t *src, float64_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_mat_mul_f32(const float32_t *src1, const float32_t *src2,
                       float32_t *dst, uint32_t row, uint32_t col, uint32_t col2);

void nds_mat_mul_f64(const float64_t *src1, const float64_t *src2,
 ...
 */
void nds_mat_mul_q15(const q15_t *src1, const q15_t *src2,
 ...
 */
void nds_mat_mul_q31(const q31_t *src1, const q31_t *src2,
                       q31_t *dst, uint32_t row, uint32_t col, uint32_t col2);
void nds_mat_oprod_q31(const q31_t * src1, const q31_t * src2,
                       q31_t * dst, uint32_t size1, uint32_t size2);

// Matrix Power 2 Function
//
// The input is a square matrix for nds_mat_pow2_cache_f64.
int32_t nds_mat_pwr2_cache_f64(const float64_t *src, float64_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_mat_scale_f32(const float32_t *src, float32_t scale,
                         float32_t *dst, uint32_t row, uint32_t col);
 ...
 */
void nds_mat_scale_q15(const q15_t *src, q15_t scale_fract, int32_t shift,
                         q15_t *dst, uint32_t row, uint32_t col);
 ...
 */
void nds_mat_scale_q31(const q31_t *src, q31_t scale_fract, int32_t shift,
                         q31_t *dst, uint32_t row, uint32_t col);
 ...
 * @return none.
 */
void nds_mat_sub_f32(const float32_t *src1, const float32_t *src2,
                       float32_t *dst, uint32_t row, uint32_t col);
 ...
 * The output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
void nds_mat_sub_q15(const q15_t *src1, const q15_t *src2,
                       q15_t *dst, uint32_t row, uint32_t col);
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
void nds_mat_sub_q31(const q31_t *src1, const q31_t *src2,
                       q31_t *dst, uint32_t row, uint32_t col);
 ...
 * @return none.
 */
void nds_mat_trans_f32(const float32_t *src, float32_t *dst, uint32_t row,
                         uint32_t col);
 ...
 * @return none.
 */
void nds_mat_trans_q15(const q15_t *src, q15_t *dst, uint32_t row,
                         uint32_t col);
 ...
 * @return none.
 */
void nds_mat_trans_q31(const q31_t *src, q31_t *dst, uint32_t row,
                         uint32_t col);
 ...
 * @return none.
 */
void nds_mat_trans_u8(const uint8_t *src, uint8_t *dst, uint32_t row, uint32_t col);
