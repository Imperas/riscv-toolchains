 ...
 * @return none.
 */
void nds_fir_f32(const nds_fir_f32_t *instance, float32_t *src,
 ...
 */
void nds_fir_q31(const nds_fir_q31_t *instance, q31_t *src,
 ...
 * completely the input signal must be scaled down by log2(coeff_size) bits.
 */
void nds_fir_fast_q31(const nds_fir_q31_t *instance, q31_t *src,
                   q31_t *dst, uint32_t size);
/**
 ...
 */
void nds_fir_q15(const nds_fir_q15_t *instance, q15_t *src,
 ...
 */
void nds_fir_fast_q15(const nds_fir_q15_t *instance, q15_t *src,
                   q15_t *dst, uint32_t size);
/**
 ...
 */
void nds_fir_q7(const nds_fir_q7_t *instance, q7_t *src, q7_t *dst,
                  uint32_t size);
 ...
 * @return none.
 */
void nds_lfir_f32(const nds_lfir_f32_t *instance, float32_t *src,
                    float32_t *dst, uint32_t size);
 ...
 * @return none.
 */
void nds_lfir_q15(const nds_lfir_q15_t *instance, q15_t *src,
                    q15_t *dst, uint32_t size);
 ...
 * 2*log2(stage) bits.
 */
void nds_lfir_q31(const nds_lfir_q31_t *instance, q31_t *src,
                    q31_t *dst, uint32_t size);
...
void nds_dcmfir_f32(const nds_dcmfir_f32_t *instance, float32_t *src,
                      float32_t *dst, uint32_t size);
void nds_dcmfir_q15(const nds_dcmfir_q15_t *instance, q15_t *src,
                      q15_t *dst, uint32_t size);
void nds_dcmfir_q31(const nds_dcmfir_q31_t *instance, q31_t *src,
                      q31_t *dst, uint32_t size);
...
void nds_upsplfir_f32(const nds_upsplfir_f32_t *instance, float32_t *src,
                        float32_t *dst, uint32_t size);
void nds_upsplfir_q15(const nds_upsplfir_q15_t *instance, q15_t *src,
                        q15_t *dst, uint32_t size);
void nds_upsplfir_q31(const nds_upsplfir_q31_t *instance, q31_t *src,
                        q31_t *dst, uint32_t size);
...
void nds_spafir_f32(nds_spafir_f32_t *instance, float32_t *src,
                      float32_t *dst, float32_t *buf, uint32_t size);
void nds_spafir_q15(nds_spafir_q15_t *instance, q15_t *src,
                      q15_t *dst, q15_t *buf1, q31_t *buf2, uint32_t size);
void nds_spafir_q31(nds_spafir_q31_t *instance, q31_t *src,
                      q31_t *dst, q31_t *buf, uint32_t size);
void nds_spafir_q7(nds_spafir_q7_t *instance, q7_t *src,
 ...
 * @return none.
 */
void nds_lms_f32(const nds_lms_f32_t *instance, float32_t *src,
 ...
 * completely the input signal must be scaled down by log2(coeff_size) bits.
 */
void nds_lms_q31(const nds_lms_q31_t *instance, q31_t *src, q31_t *ref,
 ...
 * saturated to yield a result in 1.15 format.
 */
void nds_lms_q15(const nds_lms_q15_t *instance, q15_t *src, q15_t *ref,
...
void nds_nlms_f32(nds_nlms_f32_t *instance, float32_t *src,
                    float32_t *ref, float32_t *dst, float32_t *err, uint32_t size);
...
void nds_nlms_q31(nds_nlms_q31_t *instance, q31_t *src,
...
void nds_nlms_q15(nds_nlms_q15_t *instance, q15_t *src,
 ...
 * @return none.
 */
void nds_conv_f32(float32_t *src1, uint32_t len1,
 ...
 */
void nds_conv_q15(q15_t *src1, uint32_t len1,
 ...
 */
void nds_conv_q31(q31_t *src1, uint32_t len1,
 ...
 * discarding the low 7 bits and then saturated to 1.7 format.
 */
void nds_conv_q7(q7_t *src1, uint32_t len1,
 ...
 */
int32_t nds_conv_partial_f32(float32_t *src1, uint32_t len1,
 ...
 *                  -1; fail,  the input subset are not between 0 and len1+len2-2.
 */
int32_t nds_conv_partial_q15(q15_t *src1, uint32_t len1,
 ...
 *                  -1; fail,  the input subset are not between 0 and len1+len2-2.
 */
int32_t nds_conv_partial_q31(q31_t *src1, uint32_t len1,
 ...
 *                  -1; fail,  the input subset are not between 0 and len1+len2-2.
 */
int32_t nds_conv_partial_q7(q7_t *src1, uint32_t len1,
 ...
 * @return none.
 */
void nds_corr_f32(float32_t *src1, uint32_t len1,
                    float32_t *src2, uint32_t len2, float32_t *dst);
 ...
 * discarding the low 15 bits and then saturated to 1.15 format.
 */
void nds_corr_q15(q15_t *src1, uint32_t len1,
                    q15_t *src2, uint32_t len2, q15_t *dst);
 ...
 */
void nds_corr_q31(q31_t *src1, uint32_t len1,
                    q31_t *src2, uint32_t len2, q31_t *dst);
 ...
 * discarding the low 7 bits and then saturated to 1.7 format.
 */
void nds_corr_q7(q7_t *src1, uint32_t len1,
                   q7_t *src2, uint32_t len2, q7_t *dst);
...
typedef struct
{
    ...
    q31_t *coeff;       // Points to the array of coefficients. The array is oflength 5*nstage.
    int8_t shift;       // Additional bits shift.
} nds_bq_df1_32x64_q31_t;



void nds_bq_df1_f32(const nds_bq_df1_f32_t *instance, float32_t *src, float32_t *dst, uint32_t size);
void nds_bq_df1_q15(const nds_bq_df1_q15_t *instance, q15_t *src, q15_t *dst, uint32_t size);
void nds_bq_df1_q31(const nds_bq_df1_q31_t *instance, q31_t *src, q31_t *dst, uint32_t size);
void nds_bq_df1_32x64_q31(const nds_bq_df1_32x64_q31_t *instance, q31_t *src, q31_t *dst, uint32_t size);
void nds_bq_df2T_f32(const nds_bq_df2T_f32_t *instance, float32_t *src, float32_t *dst, uint32_t size);
void nds_bq_df2T_f64(const nds_bq_df2T_f64_t *instance, float64_t *src, float64_t *dst, uint32_t size);
void nds_bq_stereo_df2T_f32(const nds_bq_stereo_df2T_f32_t *instance, float32_t *src, float32_t *dst, uint32_t size);
...
void nds_liir_f32(const nds_liir_f32_t *instance, float32_t *src,
                    float32_t *dst, uint32_t size);
void nds_liir_q31(const nds_liir_q31_t *instance, q31_t *src,
                    q31_t *dst, uint32_t size);
void nds_liir_fast_q31(const nds_liir_q31_t *instance, q31_t *src,
                    q31_t *dst, uint32_t size);
void nds_liir_q15(const nds_liir_q15_t *instance, q15_t *src,
                    q15_t *dst, uint32_t size);
void nds_liir_fast_q15(const nds_liir_q15_t *instance, q15_t *src,
                    q15_t *dst, uint32_t size);
