 ...
 */
float32_t nds_max_f32(const float32_t *src, uint32_t size,
                        uint32_t *index);
 ...
 * @return maximum value.
 */
q15_t nds_max_q15(const q15_t *src, uint32_t size, uint32_t *index);
 ...
 * @return maximum value.
 */
q31_t nds_max_q31(const q31_t *src, uint32_t size, uint32_t *index);
 ...
 * @return maximum value.
 */
q7_t nds_max_q7(const q7_t *src, uint32_t size, uint32_t *index);
 ...
 * @return max value.
 */
uint8_t nds_max_u8(const uint8_t *src, uint32_t size, uint32_t *index);
 ...
 */
float32_t nds_min_f32(const float32_t *src, uint32_t size,
                        uint32_t *index);
 ...
 * @return minimum value.
 */
q15_t nds_min_q15(const q15_t *src, uint32_t size, uint32_t *index);
 ...
 * @return minimum value.
 */
q31_t nds_min_q31(const q31_t *src, uint32_t size, uint32_t *index);
 ...
 * @return minimum value.
 */
q7_t nds_min_q7(const q7_t *src, uint32_t size, uint32_t *index);
 ...
 * @return minimum value.
 */
uint8_t nds_min_u8(const uint8_t *src, uint32_t size, uint32_t *index);
 ...
 * @return mean value.
 */
float32_t nds_mean_f32(const float32_t *src, uint32_t size);
 ...
 */
q15_t nds_mean_q15(const q15_t *src, uint32_t size);
 ...
 */
q31_t nds_mean_q31(const q31_t *src, uint32_t size);
 ...
 */
q7_t nds_mean_q7(const q7_t *src, uint32_t size);
 ...
 */
uint8_t nds_mean_u8(const uint8_t *src, uint32_t size);
 ...
 */
float32_t nds_pwr_f32(const float32_t *src, uint32_t size);
 ...
 */
q63_t nds_pwr_q15(const q15_t *src, uint32_t size);
 ...
 */
q63_t nds_pwr_q31(const q31_t *src, uint32_t size);
 ...
 */
q31_t nds_pwr_q7(const q7_t *src, uint32_t size);
 ...
 * @return RMS value.
 */
float32_t nds_rms_f32(const float32_t *src, uint32_t size);
 ...
 */
q15_t nds_rms_q15(const q15_t *src, uint32_t size);
 ...
 */
q31_t nds_rms_q31(const q31_t *src, uint32_t size);
 ...
 */
float32_t nds_std_f32(const float32_t *src, uint32_t size);
 ...
 * bits, and then saturated to yield a result in 1.15 format.
 */
q15_t nds_std_q15(const q15_t *src, uint32_t size);
 ...
 * shifted  by 31 bits to yield a 1.31 format value.
 */
q31_t nds_std_q31(const q31_t *src, uint32_t size);
 ...
 * bits, and then saturated to yield a result in 1.15 format.
 */
q15_t nds_std_u8(const uint8_t *src, uint32_t size);
 ...
 */
float32_t nds_var_f32(const float32_t *src, uint32_t size);
 ...
 * bits, and then saturated to yield a result in 1.15 format.
 */
q31_t nds_var_q15(const q15_t *src, uint32_t size);
 ...
 * shifted  by 31 bits to yield a 1.31 format value.
 */
q63_t nds_var_q31(const q31_t *src, uint32_t size);
