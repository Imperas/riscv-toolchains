...
enum insn_code {
  ...
  CODE_FOR_mulditi3 = 415,
  CODE_FOR_umulditi3 = 416,
  CODE_FOR_usmulditi3 = 417,
  CODE_FOR_mulsidi3 = 418,
  CODE_FOR_umulsidi3 = 419,
  CODE_FOR_usmulsidi3 = 420,
  CODE_FOR_zero_extendsidi2 = 421,
  CODE_FOR_zero_extendhisi2 = 422,
  CODE_FOR_zero_extendhidi2 = 423,
  CODE_FOR_extendqihi2 = 424,
  CODE_FOR_extendqisi2 = 425,
  CODE_FOR_extendqidi2 = 426,
  CODE_FOR_extendhihi2 = 427,
  CODE_FOR_extendhisi2 = 428,
  CODE_FOR_extendhidi2 = 429,
  CODE_FOR_movdi = 430,
  CODE_FOR_movsi = 431,
  CODE_FOR_movhi = 432,
  CODE_FOR_movqi = 433,
  CODE_FOR_movsf = 434,
  CODE_FOR_movdf = 435,
  CODE_FOR_cpymemsi = 436,
  CODE_FOR_clear_cache = 437,
  CODE_FOR_movsicc = 438,
  CODE_FOR_movdicc = 439,
  CODE_FOR_condjump = 440,
  CODE_FOR_cbranchqi4 = 441,
  CODE_FOR_cbranchsi4 = 442,
  CODE_FOR_cbranchdi4 = 443,
  CODE_FOR_cbranchsf4 = 444,
  CODE_FOR_cbranchdf4 = 445,
  CODE_FOR_cstoresi4 = 446,
  CODE_FOR_cstoredi4 = 447,
  CODE_FOR_cstoresf4 = 448,
  CODE_FOR_cstoredf4 = 449,
  CODE_FOR_flt_quietsfsi4 = 450,
  CODE_FOR_fle_quietsfsi4 = 451,
  CODE_FOR_flt_quietsfdi4 = 452,
  CODE_FOR_fle_quietsfdi4 = 453,
  CODE_FOR_flt_quietdfsi4 = 454,
  CODE_FOR_fle_quietdfsi4 = 455,
  CODE_FOR_flt_quietdfdi4 = 456,
  CODE_FOR_fle_quietdfdi4 = 457,
  CODE_FOR_indirect_jump = 458,
  CODE_FOR_tablejump = 459,
  CODE_FOR_prologue = 460,
  CODE_FOR_epilogue = 461,
  CODE_FOR_sibcall_epilogue = 462,
  CODE_FOR_return = 463,
  CODE_FOR_eh_return = 464,
  CODE_FOR_sibcall = 465,
  CODE_FOR_sibcall_value = 466,
  CODE_FOR_call = 467,
  CODE_FOR_call_value = 468,
  CODE_FOR_untyped_call = 469,
  CODE_FOR_restore_stack_nonlocal = 470,
  CODE_FOR_get_thread_pointersi = 471,
  CODE_FOR_get_thread_pointerdi = 472,
  CODE_FOR_stack_protect_set = 473,
  CODE_FOR_stack_protect_test = 474,
  CODE_FOR_mem_thread_fence = 475,
  CODE_FOR_atomic_compare_and_swapsi = 476,
  CODE_FOR_atomic_compare_and_swapdi = 477,
  CODE_FOR_atomic_test_and_set = 478
};

const unsigned int NUM_INSN_CODES = 479;
