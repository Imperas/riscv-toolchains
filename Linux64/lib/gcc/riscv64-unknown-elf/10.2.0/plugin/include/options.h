...
enum opt_code
{
  ...
  OPT_mshorten_memrefs = 1610,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1611,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1612,                  /* -mstrict-align */
  OPT_mtune_ = 1613,                         /* -mtune= */
  OPT_n = 1614,                              /* -n */
  OPT_name_sort = 1615,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1616,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1617,              /* -no-integrated-cpp */
  OPT_no_pie = 1618,                         /* -no-pie */
  OPT_nocpp = 1619,                          /* -nocpp */
  OPT_nodefaultlibs = 1620,                  /* -nodefaultlibs */
  OPT_nolibc = 1621,                         /* -nolibc */
  OPT_nophoboslib = 1622,                    /* -nophoboslib */
  OPT_nostartfiles = 1623,                   /* -nostartfiles */
  OPT_nostdinc = 1624,                       /* -nostdinc */
  OPT_nostdinc__ = 1625,                     /* -nostdinc++ */
  OPT_nostdlib = 1626,                       /* -nostdlib */
  OPT_o = 1627,                              /* -o */
  OPT_objects = 1628,                        /* -objects */
  OPT_p = 1629,                              /* -p */
  OPT_pass_exit_codes = 1630,                /* -pass-exit-codes */
  /* OPT_pedantic = 1631, */                 /* -pedantic */
  OPT_pedantic_errors = 1632,                /* -pedantic-errors */
  OPT_pg = 1633,                             /* -pg */
  OPT_pie = 1634,                            /* -pie */
  OPT_pipe = 1635,                           /* -pipe */
  OPT_print_file_name_ = 1636,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1637,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1638,          /* -print-multi-directory */
  OPT_print_multi_lib = 1639,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1640,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1641,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1642,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1643,               /* -print-prog-name= */
  OPT_print_search_dirs = 1644,              /* -print-search-dirs */
  OPT_print_sysroot = 1645,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1646,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1647,                    /* -print-value */
  OPT_quiet = 1648,                          /* -quiet */
  OPT_r = 1649,                              /* -r */
  OPT_remap = 1650,                          /* -remap */
  OPT_reverse_sort = 1651,                   /* -reverse-sort */
  OPT_s = 1652,                              /* -s */
  OPT_save_temps = 1653,                     /* -save-temps */
  OPT_save_temps_ = 1654,                    /* -save-temps= */
  OPT_shared = 1655,                         /* -shared */
  OPT_shared_libgcc = 1656,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1657,               /* -shared-libphobos */
  OPT_size_sort = 1658,                      /* -size-sort */
  /* OPT_specs = 1659, */                    /* -specs */
  OPT_specs_ = 1660,                         /* -specs= */
  OPT_static = 1661,                         /* -static */
  OPT_static_libasan = 1662,                 /* -static-libasan */
  OPT_static_libgcc = 1663,                  /* -static-libgcc */
  OPT_static_libgfortran = 1664,             /* -static-libgfortran */
  OPT_static_libgo = 1665,                   /* -static-libgo */
  OPT_static_liblsan = 1666,                 /* -static-liblsan */
  OPT_static_libmpx = 1667,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1668,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1669,               /* -static-libphobos */
  OPT_static_libstdc__ = 1670,               /* -static-libstdc++ */
  OPT_static_libtsan = 1671,                 /* -static-libtsan */
  OPT_static_libubsan = 1672,                /* -static-libubsan */
  OPT_static_pie = 1673,                     /* -static-pie */
  /* OPT_std_c__03 = 1674, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1675, */                /* -std=c++0x */
  OPT_std_c__11 = 1676,                      /* -std=c++11 */
  OPT_std_c__14 = 1677,                      /* -std=c++14 */
  OPT_std_c__17 = 1678,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1679, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1680, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1681, */                /* -std=c++20 */
  OPT_std_c__2a = 1682,                      /* -std=c++2a */
  OPT_std_c__98 = 1683,                      /* -std=c++98 */
  OPT_std_c11 = 1684,                        /* -std=c11 */
  OPT_std_c17 = 1685,                        /* -std=c17 */
  /* OPT_std_c18 = 1686, */                  /* -std=c18 */
  /* OPT_std_c1x = 1687, */                  /* -std=c1x */
  OPT_std_c2x = 1688,                        /* -std=c2x */
  /* OPT_std_c89 = 1689, */                  /* -std=c89 */
  OPT_std_c90 = 1690,                        /* -std=c90 */
  OPT_std_c99 = 1691,                        /* -std=c99 */
  /* OPT_std_c9x = 1692, */                  /* -std=c9x */
  OPT_std_f2003 = 1693,                      /* -std=f2003 */
  OPT_std_f2008 = 1694,                      /* -std=f2008 */
  OPT_std_f2008ts = 1695,                    /* -std=f2008ts */
  OPT_std_f2018 = 1696,                      /* -std=f2018 */
  OPT_std_f95 = 1697,                        /* -std=f95 */
  OPT_std_gnu = 1698,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1699, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1700, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1701,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1702,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1703,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1704, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1705, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1706, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1707,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1708,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1709,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1710,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1711, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1712, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1713,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1714, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1715,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1716,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1717, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1718, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1719,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1720, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1721, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1722, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1723, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1724, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1725,                     /* -std=legacy */
  OPT_symbol_ = 1726,                        /* -symbol= */
  OPT_symbolic = 1727,                       /* -symbolic */
  OPT_t = 1728,                              /* -t */
  OPT_time = 1729,                           /* -time */
  OPT_time_ = 1730,                          /* -time= */
  OPT_traditional = 1731,                    /* -traditional */
  OPT_traditional_cpp = 1732,                /* -traditional-cpp */
  OPT_tree_stats = 1733,                     /* -tree-stats */
  OPT_trigraphs = 1734,                      /* -trigraphs */
  OPT_type_stats = 1735,                     /* -type-stats */
  OPT_u = 1736,                              /* -u */
  OPT_undef = 1737,                          /* -undef */
  OPT_v = 1738,                              /* -v */
  OPT_version = 1739,                        /* -version */
  OPT_w = 1740,                              /* -w */
  OPT_wrapper = 1741,                        /* -wrapper */
  OPT_x = 1742,                              /* -x */
  OPT_z = 1743,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
