...
enum insn_code {
  ...
  CODE_FOR_mulditi3 = 342,
  CODE_FOR_umulditi3 = 343,
  CODE_FOR_usmulditi3 = 344,
  CODE_FOR_mulsidi3 = 345,
  CODE_FOR_umulsidi3 = 346,
  CODE_FOR_usmulsidi3 = 347,
  CODE_FOR_movdi = 348,
  CODE_FOR_movsi = 349,
  CODE_FOR_movhi = 350,
  CODE_FOR_movqi = 351,
  ...
  CODE_FOR_clear_cache = 355,
  CODE_FOR_movsicc = 356,
  CODE_FOR_movdicc = 357,
  CODE_FOR_condjump = 358,
  CODE_FOR_cbranchqi4 = 359,
  CODE_FOR_cbranchsi4 = 360,
  CODE_FOR_cbranchdi4 = 361,
  CODE_FOR_cbranchsf4 = 362,
  CODE_FOR_cbranchdf4 = 363,
  CODE_FOR_cstoresi4 = 364,
  CODE_FOR_cstoredi4 = 365,
  CODE_FOR_cstoresf4 = 366,
  CODE_FOR_cstoredf4 = 367,
  CODE_FOR_flt_quietsfsi4 = 368,
  CODE_FOR_fle_quietsfsi4 = 369,
  CODE_FOR_flt_quietsfdi4 = 370,
  CODE_FOR_fle_quietsfdi4 = 371,
  CODE_FOR_flt_quietdfsi4 = 372,
  CODE_FOR_fle_quietdfsi4 = 373,
  CODE_FOR_flt_quietdfdi4 = 374,
  CODE_FOR_fle_quietdfdi4 = 375,
  CODE_FOR_indirect_jump = 376,
  CODE_FOR_tablejump = 377,
  CODE_FOR_prologue = 378,
  CODE_FOR_epilogue = 379,
  CODE_FOR_sibcall_epilogue = 380,
  CODE_FOR_return = 381,
  CODE_FOR_eh_return = 382,
  CODE_FOR_sibcall = 383,
  CODE_FOR_sibcall_value = 384,
  CODE_FOR_call = 385,
  CODE_FOR_call_value = 386,
  CODE_FOR_untyped_call = 387,
  CODE_FOR_restore_stack_nonlocal = 388,
  CODE_FOR_mem_thread_fence = 389,
  CODE_FOR_atomic_compare_and_swapsi = 390,
  CODE_FOR_atomic_compare_and_swapdi = 391,
  CODE_FOR_atomic_test_and_set = 392
};

const unsigned int NUM_INSN_CODES = 393;
