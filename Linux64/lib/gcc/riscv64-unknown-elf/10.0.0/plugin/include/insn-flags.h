...
#define HAVE_clzsi2 (TARGET_BITMANIP)
#define HAVE_clzdi2 (TARGET_64BIT && TARGET_BITMANIP)
#define HAVE_ctzsi2 (TARGET_BITMANIP)
#define HAVE_ctzdi2 (TARGET_64BIT && TARGET_BITMANIP)
#define HAVE_popcountsi2 (TARGET_BITMANIP)
#define HAVE_popcountdi2 (TARGET_64BIT && TARGET_BITMANIP)
#define HAVE_sminsi3 ((TARGET_BITMANIP) && (!TARGET_64BIT))
#define HAVE_smaxsi3 ((TARGET_BITMANIP) && (!TARGET_64BIT))
#define HAVE_uminsi3 ((TARGET_BITMANIP) && (!TARGET_64BIT))
#define HAVE_umaxsi3 ((TARGET_BITMANIP) && (!TARGET_64BIT))
#define HAVE_smindi3 ((TARGET_BITMANIP) && (TARGET_64BIT))
#define HAVE_smaxdi3 ((TARGET_BITMANIP) && (TARGET_64BIT))
#define HAVE_umindi3 ((TARGET_BITMANIP) && (TARGET_64BIT))
#define HAVE_umaxdi3 ((TARGET_BITMANIP) && (TARGET_64BIT))
#define HAVE_rotrsi3 (TARGET_BITMANIP)
#define HAVE_rotrdi3 (TARGET_64BIT && TARGET_BITMANIP)
#define HAVE_rotlsi3 (TARGET_BITMANIP)
#define HAVE_rotldi3 (TARGET_BITMANIP)
#define HAVE_rotlsi3_sext (TARGET_BITMANIP)
#define HAVE_bswapsi2 (TARGET_BITMANIP)
#define HAVE_bswapdi2 (TARGET_64BIT && TARGET_BITMANIP)
...
#define HAVE_riscv_rolw (TARGET_BITMANIP && TARGET_64BIT)
