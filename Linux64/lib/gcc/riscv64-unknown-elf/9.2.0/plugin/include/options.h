...
#endif
#ifdef GENERATOR_FILE
extern int riscv_mcheck_constraints;
#else
  int x_riscv_mcheck_constraints;
#define riscv_mcheck_constraints global_options.x_riscv_mcheck_constraints
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mcheck_constraints = 1278,             /* -mcheck-constraints */
  OPT_mcmodel_ = 1279,                       /* -mcmodel= */
  OPT_mdiv = 1280,                           /* -mdiv */
  OPT_mexplicit_relocs = 1281,               /* -mexplicit-relocs */
  OPT_mfdiv = 1282,                          /* -mfdiv */
  OPT_mplt = 1283,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1284,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1285,                         /* -mrelax */
  OPT_mriscv_attribute = 1286,               /* -mriscv-attribute */
  OPT_msave_restore = 1287,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1288,             /* -msmall-data-limit= */
  ...
  OPT_nocpp = 1295,                          /* -nocpp */
  OPT_nodefaultlibs = 1296,                  /* -nodefaultlibs */
  OPT_nolibc = 1297,                         /* -nolibc */
  OPT_nophoboslib = 1298,                    /* -nophoboslib */
  OPT_nostartfiles = 1299,                   /* -nostartfiles */
  OPT_nostdinc = 1300,                       /* -nostdinc */
  OPT_nostdinc__ = 1301,                     /* -nostdinc++ */
  OPT_nostdlib = 1302,                       /* -nostdlib */
  OPT_o = 1303,                              /* -o */
  OPT_p = 1304,                              /* -p */
  OPT_pass_exit_codes = 1305,                /* -pass-exit-codes */
  /* OPT_pedantic = 1306, */                 /* -pedantic */
  OPT_pedantic_errors = 1307,                /* -pedantic-errors */
  OPT_pg = 1308,                             /* -pg */
  OPT_pie = 1309,                            /* -pie */
  OPT_pipe = 1310,                           /* -pipe */
