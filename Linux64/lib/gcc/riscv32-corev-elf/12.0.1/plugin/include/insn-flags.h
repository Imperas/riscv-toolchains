...
#define HAVE_riscv_cv_elw_si (TARGET_XCOREVELW && !TARGET_64BIT)
...
#define HAVE_riscv_cv_mac_mac (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_msu (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_muluN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulhhuN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulsN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulhhsN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_muluRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulhhuRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulsRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_mulhhsRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_macuN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_machhuN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_macsN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_machhsN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_macuRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_machhuRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_macsRN (TARGET_XCOREVMAC && !TARGET_64BIT)
#define HAVE_riscv_cv_mac_machhsRN (TARGET_XCOREVMAC && !TARGET_64BIT)
...
extern rtx        gen_riscv_cv_elw_si           (rtx, rtx);
...
extern rtx        gen_riscv_cv_mac_mac          (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_msu          (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_muluN        (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulhhuN      (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulsN        (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulhhsN      (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_muluRN       (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulhhuRN     (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulsRN       (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_mulhhsRN     (rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_macuN        (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_machhuN      (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_macsN        (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_machhsN      (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_macuRN       (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_machhuRN     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_macsRN       (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_riscv_cv_mac_machhsRN     (rtx, rtx, rtx, rtx, rtx);
