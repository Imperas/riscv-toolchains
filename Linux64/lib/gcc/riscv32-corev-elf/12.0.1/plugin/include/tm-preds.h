...
extern bool riscv_stack_push_operation (rtx, machine_mode);
extern bool riscv_stack_pop_operation (rtx, machine_mode);
extern bool pop_return_value_constant (rtx, machine_mode);
