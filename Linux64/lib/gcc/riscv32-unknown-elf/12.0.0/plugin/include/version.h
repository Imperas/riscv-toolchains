...
#define version_string "12.0.0 20211027 (experimental)"
#define pkgversion_string "('riscv32-embecosm-gcc-ubuntu1804-20211027') "
...
#define bug_report_url "<'https://www.embecosm.com'>"
