...
enum opt_code
{
  ...
  OPT_list = 1701,                           /* -list */
  OPT_mabi_ = 1702,                          /* -mabi= */
  OPT_malign_data_ = 1703,                   /* -malign-data= */
  ...
  OPT_mcpu_ = 1708,                          /* -mcpu= */
  OPT_mdiv = 1709,                           /* -mdiv */
  OPT_mexplicit_relocs = 1710,               /* -mexplicit-relocs */
  OPT_mfdiv = 1711,                          /* -mfdiv */
  OPT_misa_spec_ = 1712,                     /* -misa-spec= */
  OPT_mlittle_endian = 1713,                 /* -mlittle-endian */
  OPT_mplt = 1714,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1715,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1716,                         /* -mrelax */
  OPT_mriscv_attribute = 1717,               /* -mriscv-attribute */
  OPT_msave_restore = 1718,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1719,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1720,             /* -msmall-data-limit= */
