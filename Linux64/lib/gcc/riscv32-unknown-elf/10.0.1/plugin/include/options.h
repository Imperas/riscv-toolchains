...
#endif
#ifdef GENERATOR_FILE
extern HOST_WIDE_INT riscv_bitmanip_subset_flags;
#else
  HOST_WIDE_INT x_riscv_bitmanip_subset_flags;
#define riscv_bitmanip_subset_flags global_options.x_riscv_bitmanip_subset_flags
#endif
#ifdef GENERATOR_FILE
extern HOST_WIDE_INT riscv_subset_flags;
#else
  HOST_WIDE_INT x_riscv_subset_flags;
#define riscv_subset_flags global_options.x_riscv_subset_flags
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wpessimizing_move = 613,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 614, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 615,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 616,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 617,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 618,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 619,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 620,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 621,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 622,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 623,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 624,                       /* -Wprotocol */
  OPT_Wpsabi = 625,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 626,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 627,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 628,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 629,                /* -Wredundant-decls */
  OPT_Wredundant_move = 630,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 631,                 /* -Wredundant-tags */
  OPT_Wregister = 632,                       /* -Wregister */
  OPT_Wreorder = 633,                        /* -Wreorder */
  OPT_Wrestrict = 634,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 635,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 636,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 637,           /* -Wscalar-storage-order */
  OPT_Wselector = 638,                       /* -Wselector */
  OPT_Wsequence_point = 639,                 /* -Wsequence-point */
  OPT_Wshadow = 640,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 641, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 642,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 643, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 644,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 645, */            /* -Wshadow=global */
  OPT_Wshadow_local = 646,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 647,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 648,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 649,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 650, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 651,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 652,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 653,                /* -Wsign-conversion */
  OPT_Wsign_promo = 654,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 655,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 656,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 657,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 658,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 659,                    /* -Wspeculative */
  OPT_Wstack_protector = 660,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 661,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 662,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 663,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 664,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 665,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 666,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 667,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 668,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 669,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 670, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 671,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 672,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 673,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 674,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 675,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 676,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 677,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 678,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 679,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 680,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 681,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 682,               /* -Wsuggest-override */
  OPT_Wsurprising = 683,                     /* -Wsurprising */
  OPT_Wswitch = 684,                         /* -Wswitch */
  OPT_Wswitch_bool = 685,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 686,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 687,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 688,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 689,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 690,                      /* -Wsync-nand */
  OPT_Wsynth = 691,                          /* -Wsynth */
  OPT_Wsystem_headers = 692,                 /* -Wsystem-headers */
  OPT_Wtabs = 693,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 694,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 695,           /* -Wtautological-compare */
  OPT_Wtemplates = 696,                      /* -Wtemplates */
  OPT_Wterminate = 697,                      /* -Wterminate */
  OPT_Wtraditional = 698,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 699,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 700,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 701,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 702,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 703,            /* -Wundeclared-selector */
  OPT_Wundef = 704,                          /* -Wundef */
  OPT_Wundefined_do_loop = 705,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 706,                      /* -Wunderflow */
  OPT_Wuninitialized = 707,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 708,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 709, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 710, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 711,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 712,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 713,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 714,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 715, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 716,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 717,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 718,                /* -Wunused-function */
  OPT_Wunused_label = 719,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 720,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 721,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 722,               /* -Wunused-parameter */
  OPT_Wunused_result = 723,                  /* -Wunused-result */
  OPT_Wunused_value = 724,                   /* -Wunused-value */
  OPT_Wunused_variable = 725,                /* -Wunused-variable */
  OPT_Wuse_without_only = 726,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 727,                   /* -Wuseless-cast */
  OPT_Wvarargs = 728,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 729,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 730,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 731,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 732,            /* -Wvirtual-move-assign */
  OPT_Wvla = 733,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 734,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 735,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 736,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 737,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 738,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 739,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 740,                       /* -Wzerotrip */
  OPT_X = 741,                               /* -X */
  OPT_Xassembler = 742,                      /* -Xassembler */
  OPT_Xf = 743,                              /* -Xf */
  OPT_Xlinker = 744,                         /* -Xlinker */
  OPT_Xpreprocessor = 745,                   /* -Xpreprocessor */
  OPT_Z = 746,                               /* -Z */
  OPT_ansi = 747,                            /* -ansi */
  OPT_aux_info = 748,                        /* -aux-info */
  /* OPT_aux_info_ = 749, */                 /* -aux-info= */
  OPT_auxbase = 750,                         /* -auxbase */
  OPT_auxbase_strip = 751,                   /* -auxbase-strip */
  OPT_c = 752,                               /* -c */
  OPT_callgraph = 753,                       /* -callgraph */
  OPT_coverage = 754,                        /* -coverage */
  OPT_cpp = 755,                             /* -cpp */
  OPT_cpp_ = 756,                            /* -cpp= */
  OPT_d = 757,                               /* -d */
  OPT_debuglib_ = 758,                       /* -debuglib= */
  OPT_defaultlib_ = 759,                     /* -defaultlib= */
  OPT_defined_only = 760,                    /* -defined-only */
  OPT_demangle = 761,                        /* -demangle */
  OPT_dstartfiles = 762,                     /* -dstartfiles */
  OPT_dump_body_ = 763,                      /* -dump-body= */
  OPT_dump_level_ = 764,                     /* -dump-level= */
  OPT_dumpbase = 765,                        /* -dumpbase */
  OPT_dumpdir = 766,                         /* -dumpdir */
  OPT_dumpfullversion = 767,                 /* -dumpfullversion */
  OPT_dumpmachine = 768,                     /* -dumpmachine */
  OPT_dumpspecs = 769,                       /* -dumpspecs */
  OPT_dumpversion = 770,                     /* -dumpversion */
  OPT_e = 771,                               /* -e */
  OPT_export_dynamic = 772,                  /* -export-dynamic */
  OPT_fPIC = 773,                            /* -fPIC */
  OPT_fPIE = 774,                            /* -fPIE */
  OPT_fRTS_ = 775,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 776,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 777,                   /* -fabi-version= */
  OPT_faccess_control = 778,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 779,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 780,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 781,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 782,                  /* -falign-commons */
  OPT_falign_functions = 783,                /* -falign-functions */
  OPT_falign_functions_ = 784,               /* -falign-functions= */
  OPT_falign_jumps = 785,                    /* -falign-jumps */
  OPT_falign_jumps_ = 786,                   /* -falign-jumps= */
  OPT_falign_labels = 787,                   /* -falign-labels */
  OPT_falign_labels_ = 788,                  /* -falign-labels= */
  OPT_falign_loops = 789,                    /* -falign-loops */
  OPT_falign_loops_ = 790,                   /* -falign-loops= */
  /* OPT_faligned_new = 791, */              /* -faligned-new */
  OPT_faligned_new_ = 792,                   /* -faligned-new= */
  OPT_fall_instantiations = 793,             /* -fall-instantiations */
  OPT_fall_intrinsics = 794,                 /* -fall-intrinsics */
  OPT_fall_virtual = 795,                    /* -fall-virtual */
  OPT_fallocation_dce = 796,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 797,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 798,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 799,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 800,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 801,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 802,         /* -falt-external-templates */
  OPT_fanalyzer = 803,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 804,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 805,              /* -fanalyzer-checker= */
  OPT_fanalyzer_fine_grained = 806,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 807,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 808,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 809,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 810,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 811,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 812, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 813,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 814, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 815, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 816, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 817, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 818,            /* -fasan-shadow-offset= */
  OPT_fasm = 819,                            /* -fasm */
  OPT_fassert = 820,                         /* -fassert */
  OPT_fassociative_math = 821,               /* -fassociative-math */
  OPT_fassume_phsa = 822,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 823,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 824,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 825,                   /* -fauto-profile */
  OPT_fauto_profile_ = 826,                  /* -fauto-profile= */
  OPT_fautomatic = 827,                      /* -fautomatic */
  OPT_fbackslash = 828,                      /* -fbackslash */
  OPT_fbacktrace = 829,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 830,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 831,                   /* -fbounds-check */
  OPT_fbounds_check_ = 832,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 833,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 834,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 835, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 836, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 837, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 838,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 839,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 840,                        /* -fbuiltin */
  OPT_fbuiltin_ = 841,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 842,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 843,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 844,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 845,                    /* -fcall-saved- */
  OPT_fcall_used_ = 846,                     /* -fcall-used- */
  OPT_fcaller_saves = 847,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 848,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 849,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 850,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 851, */            /* -fcf-protection */
  OPT_fcf_protection_ = 852,                 /* -fcf-protection= */
  OPT_fchar8_t = 853,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 854,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 855, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 856,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 857,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 858,                         /* -fcheck= */
  OPT_fchecking = 859,                       /* -fchecking */
  OPT_fchecking_ = 860,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 861,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 862,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 863,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 864,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 865,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 866,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 867,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 868,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 869, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 870,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 871,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 872,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 873, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 874,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 875,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 876,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 877,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 878,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 879, */                 /* -fcilkplus */
  OPT_fcoarray_ = 880,                       /* -fcoarray= */
  OPT_fcode_hoisting = 881,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 882,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 883,                         /* -fcommon */
  OPT_fcompare_debug = 884,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 885,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 886,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 887,                   /* -fcompare-elim */
  OPT_fconcepts = 888,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 889,    /* -fconcepts-diagnostics-depth= */
  ...
  OPT_fshort_enums = 1359,                   /* -fshort-enums */
  OPT_fshort_wchar = 1360,                   /* -fshort-wchar */
  OPT_fshow_column = 1361,                   /* -fshow-column */
  OPT_fshrink_wrap = 1362,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1363,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1364,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1365,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1366,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1367,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1368,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1369,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1370,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1371,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1372,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1373,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1374,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1375,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1376,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1377,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1378,                      /* -fsquangle */
  OPT_fssa_backprop = 1379,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1380,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1381,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1382,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1383, */             /* -fstack-check */
  OPT_fstack_check_ = 1384,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1385,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1386,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1387,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1388,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1389,               /* -fstack-protector */
  OPT_fstack_protector_all = 1390,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1391,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1392,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1393,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1394,                   /* -fstack-usage */
  OPT_fstats = 1395,                         /* -fstats */
  OPT_fstdarg_opt = 1396,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1397,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1398, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1399,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1400,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1401,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1402,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1403,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1404, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1405,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1406,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1407,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1408,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1409,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1410, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1411,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1412, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1413,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1414, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1415,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1416,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1417,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1418,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1419,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1420,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1421,                   /* -ftime-report */
  OPT_ftime_report_details = 1422,           /* -ftime-report-details */
  OPT_ftls_model_ = 1423,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1424,              /* -ftoplevel-reorder */
  OPT_ftracer = 1425,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1426,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1427,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1428,                   /* -ftrampolines */
  OPT_ftransition_all = 1429,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1430,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1431,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1432,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1433,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1434,              /* -ftransition=field */
  OPT_ftransition_import = 1435,             /* -ftransition=import */
  OPT_ftransition_nogc = 1436,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1437,                /* -ftransition=tls */
  OPT_ftrapping_math = 1438,                 /* -ftrapping-math */
  OPT_ftrapv = 1439,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1440,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1441,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1442,                      /* -ftree-ccp */
  OPT_ftree_ch = 1443,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1444, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1445,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1446,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1447, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1448,                   /* -ftree-cselim */
  OPT_ftree_dce = 1449,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1450,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1451,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1452,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1453,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1454, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1455,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1456,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1457, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1458,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1459,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1460, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1461,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1462,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1463,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1464,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1465,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1466,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1467,                      /* -ftree-pre */
  OPT_ftree_pta = 1468,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1469,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1470, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1471,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1472,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1473,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1474,                     /* -ftree-slsr */
  OPT_ftree_sra = 1475,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1476, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1477, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1478,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1479,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1480,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1481, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1482,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1483, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1484,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1485,         /* -funconstrained-commons */
  OPT_funderscoring = 1486,                  /* -funderscoring */
  OPT_funit_at_a_time = 1487,                /* -funit-at-a-time */
  OPT_funittest = 1488,                      /* -funittest */
  OPT_funroll_all_loops = 1489,              /* -funroll-all-loops */
  OPT_funroll_loops = 1490,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1491, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1492,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1493,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1494,                 /* -funsigned-char */
  OPT_funswitch_loops = 1495,                /* -funswitch-loops */
  OPT_funwind_tables = 1496,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1497,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1498,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1499,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1500,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1501,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1502,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1503,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1504,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1505,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1506,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1507,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1508, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1509,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1510,                   /* -fverbose-asm */
  /* OPT_fversion = 1511, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1512,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1513,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1514,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1515,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1516,                   /* -fvisibility= */
  OPT_fvpt = 1517,                           /* -fvpt */
  OPT_fvtable_gc = 1518,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1519,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1520,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1521,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1522,                     /* -fvtv-debug */
  OPT_fweak = 1523,                          /* -fweak */
  OPT_fweb = 1524,                           /* -fweb */
  /* OPT_fwhole_file = 1525, */              /* -fwhole-file */
  OPT_fwhole_program = 1526,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1527,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1528,             /* -fworking-directory */
  OPT_fwpa = 1529,                           /* -fwpa */
  OPT_fwpa_ = 1530,                          /* -fwpa= */
  OPT_fwrapv = 1531,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1532,                 /* -fwrapv-pointer */
  OPT_fxref = 1533,                          /* -fxref */
  /* OPT_fzee = 1534, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1535,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1536,                     /* -fzero-link */
  OPT_g = 1537,                              /* -g */
  OPT_gant = 1538,                           /* -gant */
  OPT_gas_loc_support = 1539,                /* -gas-loc-support */
  OPT_gas_locview_support = 1540,            /* -gas-locview-support */
  OPT_gcoff = 1541,                          /* -gcoff */
  OPT_gcoff1 = 1542,                         /* -gcoff1 */
  OPT_gcoff2 = 1543,                         /* -gcoff2 */
  OPT_gcoff3 = 1544,                         /* -gcoff3 */
  OPT_gcolumn_info = 1545,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1546,                 /* -gdescribe-dies */
  OPT_gdwarf = 1547,                         /* -gdwarf */
  OPT_gdwarf_ = 1548,                        /* -gdwarf- */
  OPT_gen_decls = 1549,                      /* -gen-decls */
  OPT_ggdb = 1550,                           /* -ggdb */
  OPT_ggnu_pubnames = 1551,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1552,                   /* -gimple-stats */
  OPT_ginline_points = 1553,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1554, /* -ginternal-reset-location-views */
  OPT_gnat = 1555,                           /* -gnat */
  OPT_gnatO = 1556,                          /* -gnatO */
  OPT_gno_ = 1557,                           /* -gno- */
  OPT_gno_pubnames = 1558,                   /* -gno-pubnames */
  OPT_gpubnames = 1559,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1560,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1561,                   /* -gsplit-dwarf */
  OPT_gstabs = 1562,                         /* -gstabs */
  OPT_gstabs_ = 1563,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1564,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1565,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1566,                        /* -gtoggle */
  OPT_gvariable_location_views = 1567,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1568,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1569,                           /* -gvms */
  OPT_gxcoff = 1570,                         /* -gxcoff */
  OPT_gxcoff_ = 1571,                        /* -gxcoff+ */
  OPT_gz = 1572,                             /* -gz */
  OPT_gz_ = 1573,                            /* -gz= */
  OPT_h = 1574,                              /* -h */
  OPT_help = 1575,                           /* -help */
  OPT_idirafter = 1576,                      /* -idirafter */
  OPT_imacros = 1577,                        /* -imacros */
  OPT_imultiarch = 1578,                     /* -imultiarch */
  OPT_imultilib = 1579,                      /* -imultilib */
  OPT_include = 1580,                        /* -include */
  OPT_iplugindir_ = 1581,                    /* -iplugindir= */
  OPT_iprefix = 1582,                        /* -iprefix */
  OPT_iquote = 1583,                         /* -iquote */
  OPT_isysroot = 1584,                       /* -isysroot */
  OPT_isystem = 1585,                        /* -isystem */
  OPT_iwithprefix = 1586,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1587,              /* -iwithprefixbefore */
  OPT_k8 = 1588,                             /* -k8 */
  OPT_l = 1589,                              /* -l */
  OPT_lang_asm = 1590,                       /* -lang-asm */
  OPT_list = 1591,                           /* -list */
  OPT_mabi_ = 1592,                          /* -mabi= */
  OPT_malign_data_ = 1593,                   /* -malign-data= */
  OPT_march_ = 1594,                         /* -march= */
  OPT_mbranch_cost_ = 1595,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1596,                       /* -mcmodel= */
  OPT_mdiv = 1597,                           /* -mdiv */
  OPT_mexplicit_relocs = 1598,               /* -mexplicit-relocs */
  OPT_mfdiv = 1599,                          /* -mfdiv */
  OPT_mplt = 1600,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1601,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1602,                         /* -mrelax */
  OPT_mriscv_attribute = 1603,               /* -mriscv-attribute */
  OPT_msave_restore = 1604,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1605,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1606,                  /* -mstrict-align */
  OPT_mtune_ = 1607,                         /* -mtune= */
  OPT_n = 1608,                              /* -n */
  OPT_name_sort = 1609,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1610,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1611,              /* -no-integrated-cpp */
  OPT_no_pie = 1612,                         /* -no-pie */
  OPT_nocpp = 1613,                          /* -nocpp */
  OPT_nodefaultlibs = 1614,                  /* -nodefaultlibs */
  OPT_nolibc = 1615,                         /* -nolibc */
  OPT_nophoboslib = 1616,                    /* -nophoboslib */
  OPT_nostartfiles = 1617,                   /* -nostartfiles */
  OPT_nostdinc = 1618,                       /* -nostdinc */
  OPT_nostdinc__ = 1619,                     /* -nostdinc++ */
  OPT_nostdlib = 1620,                       /* -nostdlib */
  OPT_o = 1621,                              /* -o */
  OPT_objects = 1622,                        /* -objects */
  OPT_p = 1623,                              /* -p */
  OPT_pass_exit_codes = 1624,                /* -pass-exit-codes */
  /* OPT_pedantic = 1625, */                 /* -pedantic */
  OPT_pedantic_errors = 1626,                /* -pedantic-errors */
  OPT_pg = 1627,                             /* -pg */
  OPT_pie = 1628,                            /* -pie */
  OPT_pipe = 1629,                           /* -pipe */
  OPT_print_file_name_ = 1630,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1631,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1632,          /* -print-multi-directory */
  OPT_print_multi_lib = 1633,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1634,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1635,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1636,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1637,               /* -print-prog-name= */
  OPT_print_search_dirs = 1638,              /* -print-search-dirs */
  OPT_print_sysroot = 1639,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1640,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1641,                    /* -print-value */
  OPT_quiet = 1642,                          /* -quiet */
  OPT_r = 1643,                              /* -r */
  OPT_remap = 1644,                          /* -remap */
  OPT_reverse_sort = 1645,                   /* -reverse-sort */
  OPT_s = 1646,                              /* -s */
  OPT_save_temps = 1647,                     /* -save-temps */
  OPT_save_temps_ = 1648,                    /* -save-temps= */
  OPT_shared = 1649,                         /* -shared */
  OPT_shared_libgcc = 1650,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1651,               /* -shared-libphobos */
  OPT_size_sort = 1652,                      /* -size-sort */
  /* OPT_specs = 1653, */                    /* -specs */
  OPT_specs_ = 1654,                         /* -specs= */
  OPT_static = 1655,                         /* -static */
  OPT_static_libasan = 1656,                 /* -static-libasan */
  OPT_static_libgcc = 1657,                  /* -static-libgcc */
  OPT_static_libgfortran = 1658,             /* -static-libgfortran */
  OPT_static_libgo = 1659,                   /* -static-libgo */
  OPT_static_liblsan = 1660,                 /* -static-liblsan */
  OPT_static_libmpx = 1661,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1662,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1663,               /* -static-libphobos */
  OPT_static_libstdc__ = 1664,               /* -static-libstdc++ */
  OPT_static_libtsan = 1665,                 /* -static-libtsan */
  OPT_static_libubsan = 1666,                /* -static-libubsan */
  OPT_static_pie = 1667,                     /* -static-pie */
  /* OPT_std_c__03 = 1668, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1669, */                /* -std=c++0x */
  OPT_std_c__11 = 1670,                      /* -std=c++11 */
  OPT_std_c__14 = 1671,                      /* -std=c++14 */
  OPT_std_c__17 = 1672,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1673, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1674, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1675, */                /* -std=c++20 */
  OPT_std_c__2a = 1676,                      /* -std=c++2a */
  OPT_std_c__98 = 1677,                      /* -std=c++98 */
  OPT_std_c11 = 1678,                        /* -std=c11 */
  OPT_std_c17 = 1679,                        /* -std=c17 */
  /* OPT_std_c18 = 1680, */                  /* -std=c18 */
  /* OPT_std_c1x = 1681, */                  /* -std=c1x */
  OPT_std_c2x = 1682,                        /* -std=c2x */
  /* OPT_std_c89 = 1683, */                  /* -std=c89 */
  OPT_std_c90 = 1684,                        /* -std=c90 */
  OPT_std_c99 = 1685,                        /* -std=c99 */
  /* OPT_std_c9x = 1686, */                  /* -std=c9x */
  OPT_std_f2003 = 1687,                      /* -std=f2003 */
  OPT_std_f2008 = 1688,                      /* -std=f2008 */
  OPT_std_f2008ts = 1689,                    /* -std=f2008ts */
  OPT_std_f2018 = 1690,                      /* -std=f2018 */
  OPT_std_f95 = 1691,                        /* -std=f95 */
  OPT_std_gnu = 1692,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1693, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1694, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1695,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1696,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1697,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1698, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1699, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1700, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1701,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1702,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1703,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1704,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1705, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1706, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1707,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1708, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1709,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1710,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1711, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1712, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1713,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1714, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1715, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1716, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1717, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1718, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1719,                     /* -std=legacy */
  OPT_symbol_ = 1720,                        /* -symbol= */
  OPT_symbolic = 1721,                       /* -symbolic */
  OPT_t = 1722,                              /* -t */
  OPT_time = 1723,                           /* -time */
  OPT_time_ = 1724,                          /* -time= */
  OPT_traditional = 1725,                    /* -traditional */
  OPT_traditional_cpp = 1726,                /* -traditional-cpp */
  OPT_tree_stats = 1727,                     /* -tree-stats */
  OPT_trigraphs = 1728,                      /* -trigraphs */
  OPT_type_stats = 1729,                     /* -type-stats */
  OPT_u = 1730,                              /* -u */
  OPT_undef = 1731,                          /* -undef */
  OPT_v = 1732,                              /* -v */
  OPT_version = 1733,                        /* -version */
  OPT_w = 1734,                              /* -w */
  OPT_wrapper = 1735,                        /* -wrapper */
  OPT_x = 1736,                              /* -x */
  OPT_z = 1737,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
